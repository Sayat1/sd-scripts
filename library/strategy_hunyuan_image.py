...
class HunyuanImageLatentsCachingStrategy(LatentsCachingStrategy):
    ...
    def is_disk_cached_latents_expected(
        ...
        return self._default_is_disk_cached_latents_expected(
            32, bucket_reso, npz_path, flip_aug, alpha_mask, multi_resolution=True, cache_variations=cache_variations
        )
    ...
    def load_latents_from_disk(
        ...
        return self._default_load_latents_from_disk(
            32, npz_path, bucket_reso, variation_index=variation_index
