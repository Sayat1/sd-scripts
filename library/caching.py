...
def load_images_and_masks_for_caching(
    ...
    if color_aug or random_color_bg:
        from library.dataset import AugHelper

        aug_helper = AugHelper()
    else:
        aug_helper = None
    for info in image_infos:
        image = (
            load_image(info.absolute_path, use_alpha_mask or random_color_bg)
